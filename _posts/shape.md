...
![image info](/assets/blog/theory2/c.PNG)
...
![image info](/assets/blog/theory2/24.PNG)
...
Now if things were different and black already had this connection...
...
![image info](/assets/blog/theory2/proverb/1.PNG)
...
![image info](/assets/blog/theory2/proverb/3.PNG)
...
![image info](/assets/blog/theory2/proverb/9.PNG)
...
![image info](/assets/blog/theory2/proverb/10.PNG)
...
![image info](/assets/blog/theory2/proverb/11.PNG)
...
![image info](/assets/blog/theory2/proverb/12.PNG)
...
![image info](/assets/blog/theory2/proverb/15.PNG)
...
![image info](/assets/blog/theory2/proverb/16.PNG)

And so a one space extension would be a waste,

---

![image info](/assets/blog/theory2/proverb/17.PNG)
...
![image info](/assets/blog/theory2/proverb/21.PNG)

Let white respond,

---

![image info](/assets/blog/theory2/proverb/22.PNG)
...
Given this board position where black has just played the approach move on the top left corner, how should white play?

---

![image info](/assets/blog/theory2/proverb2/4.PNG)

I hope you noticed the hane at the head of two stones over here. If you did, simply close your eyes and play the hane.

---

![image info](/assets/blog/theory2/proverb2/5.PNG)

This hane threatens this sort of follow up, among others.

---

![image info](/assets/blog/theory2/proverb2/6.PNG)

So black defends like this. As a result, by striking the vital point, white is denting black's position in sente. And so this exchange alone is a significant profit for white. And all white did was notice the head of two stones, and immediately play the vital point.

---

![image info](/assets/blog/theory2/proverb2/7.PNG)

But if we ignore the vital point when it arises, and play away,

---

![image info](/assets/blog/theory2/proverb2/8.PNG)

You could potentially end up in gote,

---

![image info](/assets/blog/theory2/proverb2/9.PNG)

and end up missing your opportunity to play the vital point, and even worse, have it played against you.
...
![image info](/assets/blog/theory2/proverb2/11.PNG)

Here, If black bumps his head into the stone, this is actually contradicting the rule of hane at the head of two stones.

---

![image info](/assets/blog/theory2/proverb2/12.PNG)

White has none other than to connect under, but once we get to this position, I think it is now very clear why black's previous move contradicted the proverb. We can see that black has allowed white to make the shape where white is hitting the vital point. From white's perspective, we got to hane the head of two stones. So, black is giving white an ideal shape. And for black, this is simply just bad shape.

So what black needs to do here instead of bumping is to come up with a response that doesn't end up contradicting the proverb of hane at the head of two stones.
