...
<ImageText src="/assets/blog/theory4/8.PNG" text1="We can _surround_ with the knight's move. White can't escape now so the only option is to make two eyes on the inside.
...
So remember that, to surround your opponent's stones and force them to play a small move, is the basic concept of attack.
