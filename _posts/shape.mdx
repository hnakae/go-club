...
<ImageText src="/assets/blog/theory2/1.PNG" text1="The representative bad shape. If you don't understand why the empty triangle is bad, you can just say 'this move is bad because it's an empty triangle'. For now. The priority is to make it a habit to not play bad shape.

" text2="But just as a thought experiment, lay down three stones in a straight line and three stones in the shape of an empty triangle. Now count the liberties that each group has. Remember, both of these shapes are using the same number of stones."/>
...
<ImageText src="/assets/blog/theory2/8.PNG" text1="White extend. Now the problem here is how to respond without making bad shape.
...
<ImageText src="/assets/blog/theory2/9.PNG" text1="This response covers for the connection, but as you can see, black has formed an empty triangle.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/10.PNG" text1="Here's another response that results in an empty triangle in black's shape.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/11.PNG" text1="So looking past the previous two ways, we come across this response. This time, we avoided making an empty triange. We instead have a good shape, called a bamboo joint. This automatically moves this response up to the top of our list, compared to our previous two ideas.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/12.PNG" text1="This is an indirect response that you could think of to avoid the empty triangle, but it does leave behind a weakness. According to katago, the previous move is the best candidate, but this move would be better than making an empty triangle.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/2.PNG" text1="I think this one you've seen, an all too common mistake that allows the shape to be completely broken.
...
<ImageText src="/assets/blog/theory2/13.PNG" text1="This too, is an example of split shape. From black's perspective, this is almost strictly forbidden. From white's perspective, we absolutely jump on the opportunity to split this shape.
...
<ImageText src="/assets/blog/theory2/14.PNG" text1="Let's see an example of how this shape may arise in your games.

" text2="White has just played in between these two black stones. And here, black has to be careful to avoid the split one space jump and the split knight's move shape introduced earlier. Let's first take a look at the two responses that black must not play."/>
...
<ImageText src="/assets/blog/theory2/15.PNG" text1="This is now white's only move. And black has the split shape.

" text2=""/>

<ImageText src="/assets/blog/theory2/16.PNG" text1="Looking at this shape, we see that here too, white has an only move. and black is broken.

" text2=""/>

<ImageText src="/assets/blog/theory2/14.PNG" text1="So in this position, our goal is to avoid the above two moves and find another way.
...
<ImageText src="/assets/blog/theory2/c.PNG" text1="And if you decide to play from above instead, white will always push here. and black will extend back.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/3.PNG" text1="For this one, perhaps it's the first time you've heard of such a rule. This one is slightly less severe of a mistake than the empty triangle and split shape, but in some cases it can be even worse. Consider these three the top 3 of bad shapes.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/19.PNG" text1="There's a fight in the bottom right quadrant.
" text2=""/>

<ImageText src="/assets/blog/theory2/20.PNG" text1="White peeps this cutting point, and this is the example of a raw peep.
" text2=""/>

<ImageText src="/assets/blog/theory2/21.PNG" text1="Black's only move is to connect. Sure, it was a tiger's mouth so you may think that hey, there was no direct cut here.

" text2=""/>

<ImageText src="/assets/blog/theory2/22.PNG" text1="But before the peep and connect exchange, white had this cut, which isolates black's center group in sente.

" text2=""/>

<ImageText src="/assets/blog/theory2/23.PNG" text1="White can then move from his group on the right side because it's not alive yet, but as you can see black's center group now has no eye shape and is looking very unstable. It might even get attacked.

" text2=""/>

<ImageText src="/assets/blog/theory2/24.PNG" text1="But if we play this raw peep, we lose the chance to cut off this center group in sente, and when we run with our weak group, black's center group now has the insurance of being able to connect back to his bottom right corner. This gives black a lot of assurance going forward because he can always avoid the worst case sceneraio by connecting back. And due to this, we can say that the peep has strengthened black's center group, and inadvertently hurt our own group on the right. This severely disrupts the power balance in the upcoming center fight for no good reason at all. Let's compare the two outcomes.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/5.PNG" text1="This one is more of a proverb on good shape than an example of bad shape. It explains the efficient shape of stones. Let's see why this is considered as the standard shape.

" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/1.PNG" text1="Perhaps you have seen this pattern in the corner before. Up to here, it is a common joseki, but here the question for white is where to play the extension. Notice how the three white stones form a two stone high wall facing the left side of the board.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/proverb/2.PNG" text1="Let's say black splits the left side and white approaches the stone from above.
" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/3.PNG" text1="Black makes this two space extension. Now when asking what an extension is, you could say that this two space extension is THE standard extension. Among extensions, the two space extension is considered the most standard. And the reasoning is simple, it is the most efficient distance to make eye space and territory. The theory of extensions is, to make the largest extension possible where they will still be connected.
" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/4.PNG" text1="Even if white plays something annoying like this,
" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/5.PNG" text1="Black can hane on top in most cases,
" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/6.PNG" text1="Or at the very least hane under and stay connected.
" text2=""/>


<ImageText src="/assets/blog/theory2/proverb/7.PNG" text1="So unless under special circumstances, there is no reason why we should play such a cramped one space extension.
" text2=""/>


<ImageText src="/assets/blog/theory2/proverb/8.PNG" text1="
...
<ImageText src="/assets/blog/theory2/proverb/9.PNG" text1="Then how about the three space extension? Compared to the one space jump, this one is a viable move. So both the two space and three space can be played and they will both be a good game of go.
" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/10.PNG" text1="But locally, due to a splitting move existing, the three space extension off of the first stone is not considered a standard extension.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/proverb/15.PNG" text1="
...
<ImageText src="/assets/blog/theory2/proverb/16.PNG" text1="And so a one space extension would be a waste,

" text2=""/>

<ImageText src="/assets/blog/theory2/proverb/17.PNG" text1="And the four space extension would allow the opponent to split the shape
...
<ImageText src="/assets/blog/theory2/proverb/18.PNG" text1="White plays a pincer in response to black's approach move on the bottom left corner. Take a look at the group on the upper left hand side. Black has a two stone wall facing the left side of the board.
" text2=""/>
...
<ImageText src="/assets/blog/theory2/proverb/20.PNG" text1="
...
<ImageText src="/assets/blog/theory2/proverb/21.PNG" text1="Let white respond,
" text2=""/>



<ImageText src="/assets/blog/theory2/proverb/22.PNG" text1="And cap with the knight's move.
" text2="The balance of power has shifted in black's favor. White is in a tough spot, and black can gain control of the flow of the game."/>
...
<ImageText src="/assets/blog/theory2/proverb2/4.PNG" text1="I hope you noticed the hane at the head of two stones over here. If you did, simply close your eyes and play the hane.
" text2=""/>
