...
const MeetUpInfo = () => {
  return (
    ...
    <div className="relative bg-dark text-white   text-start  flex items-center justify-center pt-36 pb-24 sm:flex-col xs:flex-col sm:mt-0 xs:mt-0 xs:bg-[#DFF8B4] sm:mb-6 mb-36">
