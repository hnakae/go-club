...
export function Navbar() {
  ...
  return (
    <>
      {/**/}
      <section
        className={` z-50  transition-all duration-300 linear backdrop-blur-xl  bg-darkNav	shadow-md sticky top-0 left-0 flex justify-center items-center  py-2 w-screen mx-0 px-6  select-none`}
      >
