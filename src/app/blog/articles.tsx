  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center z-10 ">
        <div className=" mx-6 px-14 py-10 rounded-md mb-4 max-w-[1128px] border border-primaryColor text-neutralColor shadow-md  backdrop-blur-md ">
          ...
          <div className="grid grid-rows-1 grid-cols-3 gap-y-3 gap-x-4 ">
            ...
            <section className="relative rounded-md overflow-hidden bg-baseColor   shadow-sm  mb-3 flex flex-col border-primaryColor border hover:text-primaryColor">
              <Image
          ...
          <div className="relative w-full mb-12">
            <input
              ...
              className="w-full border rounded-lg p-4 pl-12 text-black"
              placeholder="Search..."
            />
